const DOCUMENTS = {
  ...
  'prehire-checklist': {
    ...
    html: `
      ...
      <table class="doc-table">
        <tr><th style="width:60px;">Done</th><th>Requirement</th><th>Details / Notes</th></tr>
        <tr><td style="text-align:center;">&#9744;</td><td><strong>Two-Week Notice Confirmation</strong></td><td>Written confirmation that notice has been submitted to current employer</td></tr>
        <tr><td style="text-align:center;">&#9744;</td><td><strong>Two Most Recent Pay Stubs</strong></td><td>Stubs from current/most recent employer &mdash; used for income verification</td></tr>
      </table>

      <div class="section-header">Section 3 &mdash; Payroll Setup (Gusto)</div>
      <table class="doc-table">
        <tr><th style="width:60px;">Done</th><th>Requirement</th><th>Details / Notes</th></tr>
        <tr><td style="text-align:center;">&#9744;</td><td><strong>Completed W-4</strong></td><td>Federal Employee's Withholding Certificate &mdash; required for Gusto enrollment</td></tr>
        <tr><td style="text-align:center;">&#9744;</td><td><strong>Direct Deposit Info (if applicable)</strong></td><td>Routing and account number for payroll setup (optional but preferred)</td></tr>
        <tr><td style="text-align:center;">&#9744;</td><td><strong>I-9 Supporting Documents</strong></td><td>Government-issued photo ID + eligibility document (e.g., driver's license + SS card or passport)</td></tr>
      </table>
